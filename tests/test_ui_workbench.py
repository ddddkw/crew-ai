...
class WorkbenchUiTests(unittest.TestCase):
    ...
    def test_development_workbench_pages_have_polished_surfaces(self):
        ...
        self.assertIn("padding-top: 0.45rem !important;", source)
        ...
        self.assertIn("--dev-session-shell-height: calc(100vh - 4.8rem);", source)
        self.assertIn("min-height: var(--dev-session-shell-height);", source)
        self.assertIn("height: var(--dev-session-shell-height);", source)
        ...
        self.assertIn("--dev-session-content-height: calc(var(--dev-session-shell-height) - 0.7rem);", source)
        ...
        self.assertIn("padding: 0.35rem;", source)
        ...
        self.assertIn("grid-template-columns: minmax(14rem, 0.25fr) minmax(0, 1fr);", source)
