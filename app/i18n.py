...
DEFAULT_LANGUAGE_FALLBACK = "zh"


def get_default_language():
    """Get the configured default language, falling back to Chinese."""
    return os.getenv("DEFAULT_LANGUAGE", DEFAULT_LANGUAGE_FALLBACK)
...
def get_current_language():
    ...
    if "language" not in ss:
        ...
        ss.language = default_language if default_language in get_available_languages() else DEFAULT_LANGUAGE_FALLBACK
    return ss.language
