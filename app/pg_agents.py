...
class PageAgents:
    ...
    def draw(self):
        ...
        draw_page_header(
            ...
            subtitle=t("agent.all_agents"),
            count=len(ss.agents),
        )

        with st.container(border=True, key="agents-workspace-card"):
            ...
            with tab_objects[0]:
                ...
                with st.container(key="agent-list-all"):
            ...
            with tab_objects[1]:
                ...
                with st.container(key="agent-list-unassigned"):
            ...
            for i, crew in enumerate(ss.crews, 2):
                with tab_objects[i]:
                    ...
                    with st.container(key=f"agent-list-crew-{i}"):
